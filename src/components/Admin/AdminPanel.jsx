...
const API = 'http://localhost:6161/quiz-app/getAllQuestions';

const DAPI = 'http://localhost:6161/quiz-app/deleteQuestionById/';
        ...
        return (
          ...
          <div id={index} className="as-container">
            <div className="as-choice-card">
              <h3><strong className="as-card-title">Question Number{index + 1}</strong></h3>
...
<div className="container-fluid">
  <div className="col-md-3">
    ...
    <div id="sidebar">
       <ul className="nav add-q navbar-nav side-bar">
